...
export class MovieComponent implements OnInit, AfterViewInit {
  ...
  columns: ColumnConfig[] = [
    ...
    { field: 'release_year', header: 'Year', filterType: 'numeric', type: 'numeric', width: '6rem' },
    { field: 'genres', header: 'Genres', filterType: 'text', type: 'string', width: '180px' },
    { field: 'runtime_minutes', header: 'Runtime', filterType: 'numeric', type: 'numeric', width: '6rem' },
    ...
    { field: 'budget_usd', header: 'Budget', filterType: 'numeric', type: 'numeric', width: '8rem' },
    { field: 'gross_usd', header: 'Gross', filterType: 'numeric', type: 'numeric', width: '8rem' },
    { field: 'rotten_tomatoes_scores', header: 'Rotten Tomatoes', filterType: 'numeric', type: 'numeric', width: '8rem' },
  ];
